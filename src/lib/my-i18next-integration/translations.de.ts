const translations = {
  ...
  aboutMe: {
    title: "Über mich",
    paragraph1:
      "Ob es der Adrenalinschub vor dem Start eines Sprints, das Gefühl ein entscheidendes Tor zu erzielen oder die vollkommene Ruhe beim Yoga ist… Bewegung und Sport hat mich in meinem Leben bis heute geprägt.",
    paragraph2:
  ...
  imprint: {
    ...
    copyrightNotice: `Die Inhalte und Werke, die von den Betreibern dieser Seite erstellt wurden,  unterliegen dem deutschen Urheberrecht. Jegliche Form von Vervielfältigung,  Bearbeitung, Verbreitung oder sonstiger Nutzung außerhalb der gesetzlich  erlaubten Grenzen erfordert die vorherige schriftliche Genehmigung. Downloads  und Kopien dieser Webseite dürfen ausschließlich für private und nicht  kommerzielle Zwecke verwendet werden.  Falls Inhalte auf dieser Webseite nicht vom Betreiber selbst stammen,  werden die Rechte Dritter berücksichtigt und solche Inhalte entsprechend  gekennzeichnet. Sollte Ihnen dennoch eine mögliche Verletzung des Urheberrechts  auffallen, bitten wir um einen Hinweis. Sobald wir von etwaigen Rechtsverstößen  Kenntnis erhalten, werden wir die betreffenden Inhalte unverzüglich entfernen.`,
    generator: {
